...
from vendor.models import Vendor  # Import Vendor directly from vendor app

class Payment(models.Model):
    # Link the payment to the vendor (seller)
...
class Order(models.Model):
    ...
    user = models.ForeignKey(Vendor, on_delete=models.SET_NULL, null=True)
...
class OrderProduct(models.Model):
    ...
    product = models.ForeignKey('vendor.Product', on_delete=models.PROTECT)
    variations = models.ManyToManyField('vendor.Variation', blank=True)
